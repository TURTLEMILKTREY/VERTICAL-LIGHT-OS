...
def test_imports():
    ...
    try:
        ...
        if not validation_result.success:
            ...
            print("✗ Data validation incorrectly accepted invalid data")
            return False
        ...
        if 'analysis_id' in enriched and 'created_at' in enriched:
            ...
            print("✗ Data enrichment missing required fields")
            return False
...
def check_database_files():
    ...
    for name, full_path in required_files.items():
        if full_path.exists():
            ...
            print(f"✗ {name} - MISSING (checked: {full_path})")
            all_exist = False
...
def verify_requirements():
    ...
    if requirements_file.exists():
        ...
        print(f"✗ requirements.txt not found (checked {requirements_file} and {backend_requirements})")
        return False
