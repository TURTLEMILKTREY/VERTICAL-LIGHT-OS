...
async def test_database_integration():
    ...
    if validation_result.success:
        ...
        print(f"✗ Valid data failed validation: {validation_result.error}")
        return False
    ...
    if not missing_enrichments:
        ...
        print(f"✗ Data enrichment missing: {missing_enrichments}")
        return False
    ...
    try:
        ...
        if save_result.success:
            ...
            print(f"✗ Analysis save failed: {save_result.error}")
            return False
    except Exception as e:
    ...
    try:
        ...
        print(f"✗ History retrieval exception: {e}")
        return False
    ...
    try:
        ...
        print(f"✗ Statistics retrieval exception: {e}")
        return False
...
async def test_hospital_intelligence_integration():
    ...
    try:
        ...
        if save_result.success:
            ...
            print(f"✗ Analysis persistence integration failed: {save_result.error}")
            return False
...
async def main():
    ...
    if overall_result:
        ...
        print("\n⚠️  Database integration needs fixes before production.")
